...
pre_install_docker_compose(){
    ...
    read -p "(Default bobcoder@qq.com):" cloudflare_email
    [ -z "${cloudflare_email}" ]  && cloudflare_email="bobcoder@qq.com"
    echo
    echo "---------------------------"
    ...
    read -p "(Default 3d4df18e5a8107346c73fff3162b2e4edadb8 ):" cloudflare_key
    [ -z "${cloudflare_key}" ] && cloudflare_key="3d4df18e5a8107346c73fff3162b2e4edadb8"
    echo
    echo "---------------------------"
...
pre_install_caddy(){
    ...
    read -p "(Default path: /ray):" v2ray_path
    [ -z "${v2ray_path}" ] && v2ray_path="/ray"
    echo
    echo "---------------------------"
    ...
    read -p "(Default v2ray_email: bobcoder@qq.com):" v2ray_email
    [ -z "${v2ray_email}" ] && v2ray_email="bobcoder@qq.com"
    echo
    echo "---------------------------"
